...
public class ShortViewServiceImpl implements ShortViewService {
	...
	public String myRenderShortView(String templateName, Map<String, Object> modelMap,VitroRequest vreq){
		try {
			...
			log.error(e, e);
			return "<p>Can't parse the short view template '</p>";
		} catch (TemplateProcessingException e) {
			if (e.getCause() instanceof FileNotFoundException) {
				log.error(e);
				return "<p>Can't find the short view template</p>";
			} else {
				log.error(e, e);
				return "<p>Can't process the short view template \"</p>";
			}
		} catch (Exception e) {
			log.error(e, e);
			return "<p>Failed to render the short view for </p>";
		}
	}
	...
	public String renderShortView(Individual individual,
		...
		log.info("TemplateAndSupplementalData tsd : " + tsd);
			
		String templateName = tsd.getTemplateName();
		
		log.info("String templateName : " + templateName);
			
		Map<String, Object> supplementalData = tsd.getSupplementalData();
			
		log.info("Map<String, Object> supplementalData : " + supplementalData);
	...
	public TemplateAndSupplementalData getShortViewInfo(Individual individual,
		...
		log.info("Map<String, Object> gotData : " + gotData);
	...
	private TemplateAndDataGetters fetchTemplateAndDataGetters(
		...
		log.info("we return with the default template");
	...
	private Map<String, Object> runDataGetters(Set<DataGetter> dataGetters,
		...
		log.info("run dataGetters");
		for (DataGetter dg : dataGetters) {
			log.info("DataGetter : " + dg);
