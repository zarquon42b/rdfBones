...
public class IndividualJsonWrapper {
	...
	private static final Log log = LogFactory.getLog(IndividualJsonWrapper.class);
	...
	/*
	static JSONObject packageImageAsJson(VitroRequest vrep, Individual ind){
		
		JSONObject jo = new JSONObject();
		jo.put("relatedImages", ind.getRelatedIndividuals(""));
	}
	*/
